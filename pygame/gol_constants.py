...
prey_rescaled_image = pygame.transform.scale(prey_original_image, (prey_original_image.get_rect().width // 10, prey_original_image.get_rect().height // 10))
...
predator_rescaled_image = pygame.transform.scale(predator_original_image, (predator_original_image.get_rect().width // 10, predator_original_image.get_rect().height // 10))
